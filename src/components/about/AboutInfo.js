...
function AboutInfo(){
    ...
    return (
        <Container style={{width:'75%'}} >
            ...
            <div>
                <Image className='ms-5 me-5 mt-2 mb-2' style={{width:'200px' , height:'200px', float: 'left'}} src="https://prasadyash2411.github.io/ecom-website/img/Band%20Members.png" roundedCircle />
                <p>
